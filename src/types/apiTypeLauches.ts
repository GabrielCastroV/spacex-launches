...
//
//   const aPISpaceXResponseLaunches = Convert.toAPISpaceXResponseLaunches(json);
//
// These functions will throw an error if the JSON doesn't
// match the expected interface, even if the JSON is valid.

export interface APISpaceXResponseLaunches {
...
export class Convert {
    public static toAPISpaceXResponseLaunches(json: string): APISpaceXResponseLaunches[] {
        return cast(JSON.parse(json), a(r("APISpaceXResponseLaunches")));
    }

    public static aPISpaceXResponseLaunchesToJson(value: APISpaceXResponseLaunches[]): string {
        return JSON.stringify(uncast(value, a(r("APISpaceXResponseLaunches"))), null, 2);
    }
}
